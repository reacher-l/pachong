...
# 片头
start_clip = VideoFileClip("VID_20190926_163202.mp4").subclip(0, 3.0).rotate(90).resize((1500, 750))
# 合成字幕
...
# 内容
main_clip = VideoFileClip("demo.wmv", audio=False).without_audio().subclip(0, 10.0).on_color(color=(255, 255, 255)).resize((1050, 750)).crossfadein(0.5).crossfadeout(0.5)
